...
# n_hidden_3 = 256
n_input = 256 # input dimensionality
...
with tf.Session() as sess:
	...
	summary_writer = tf.summary.FileWriter('/home/rhythm/Downloads/final_code/K_Means_Final/tmp/tensorflow_logs', graph_def=sess.graph_def)
	# Training cycle
	avg_cost = 100.
	epoch = 0
